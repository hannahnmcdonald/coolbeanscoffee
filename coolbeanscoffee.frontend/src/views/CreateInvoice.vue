<template>
  <div>
    ...
    <div class="invoice-step" v-if="invoiceStep === 3">
      ...
      <CoolBeansButton @button:click="submitInvoice"
        >Submit Invoice</CoolBeansButton
      >
      <hr />

      <div class="invoice-step-detail" id="invoice" ref="invoice">
        <div class="invoice-logo">
          <img id="imgLogo" alt="Cool Beans logo" src="../assets/logo.png" />
    ...
    <div class="invoice-steps-actions">
      <CoolBeansButton @button:click="prev" :disabled="!canGoPrev"
        >Previous</CoolBeansButton
      >
      <CoolBeansButton @button:click="next" :disabled="!canGoNext"
        >Next</CoolBeansButton
      >
      <CoolBeansButton @button:click="startOver">Start Over</CoolBeansButton>
    </div>
  </div>
</template>
...
@Component({ name: "CreateInvoice", components: { CoolBeansButton } })
